...
namespace Infrastructure.Migrations
{
    ...
    partial class FexitDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Domain.Entities.Accion", b =>
                {
                    ...
                    b.ToTable("Acciones", null, t =>
                        {
                            t.HasCheckConstraint("CK_Acciones_EscrituraCompleta", "Modo <> 'escritura' OR (Direccion IS NOT NULL AND TipoDireccion IS NOT NULL AND Valor IS NOT NULL)");
                    ...
                    b.ToTable("Equipos", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Equipos_Protocolo", "Protocolo IN ('SiemensS7','ModbusTcp','Simulado')");

                            t.HasCheckConstraint("CK_Equipos_Puerto", "Puerto > 0 AND Puerto <= 65535");

                            t.HasCheckConstraint("CK_Equipos_TipoEquipo", "TipoEquipo IN ('plc')");
                        });
                });
